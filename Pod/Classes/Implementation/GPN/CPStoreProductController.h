...
@class CPStoreProductController;

@protocol CPStoreProductControllerDelegate <NSObject>
...
@interface CPStoreProductController : CPObject

@property (nonatomic, weak) id<CPStoreProductControllerDelegate> delegate;
